...
namespace LunarDragonMod.Modules {
    ...
    internal static class Prefabs {
        ...
        private static void SetupCapsuleCollider(GameObject prefab) {
            ...
            float height = 1.8f;
            int direction = 1;
            float yOffset = 0f; // can't!!!! or bungus breaks!!!
        ...
        private static void SetupFootstepController(GameObject model) {
            ...
            if (model.GetComponent<FootstepHandler>() == null) {
                footstepHandler = model.AddComponent<FootstepHandler>();
                footstepHandler.baseFootstepString = "Play_acrid_step";
                footstepHandler.sprintFootstepOverrideString = "Play_acrid_step_sprint";
                footstepHandler.enableFootstepDust = true;
            }
            footstepHandler.footstepDustPrefab = RoR2.LegacyResourcesAPI.Load<GameObject>("Prefabs/GenericLargeFootstepDust");
        }
